...
export const userSchema = z.object({
  ...
  gender: z.nativeEnum(Gender, ErrGenderInvalid.message),
  role: z.nativeEnum(Role, ErrRoleInvalid.message),
...
export const userUpdateDTOSchema = z.object({
  ...
  address: z.string().nullable().optional(),
  birthday: z.date( ErrBirthdayInvalid.message).nullable().optional(),
  gender: z.nativeEnum(Gender, ErrGenderInvalid.message).optional(),
  role: z.nativeEnum(Role, ErrRoleInvalid.message).optional(),
  status: z.nativeEnum(Status).optional(),
});
